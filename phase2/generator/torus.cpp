...
Model modelGenTorus(int sides, int cs_sides, float radius, float cs_radius)
{
    ...
    Model2 torus=malloc(sizeof *torus + numVertices * 8 * sizeof (float) + numIndices * 2);
    ...
    torus->indices  = Indices  = (int *) (torus->tex + numVertices * 2);
